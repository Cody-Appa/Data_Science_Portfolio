...
This graph visualizes the number of times each class appears in the top 10 for every encounter type in the raid. Use this, as well as the graphs below to decide which types of DPS class to bring to each encounter. The graph has been faceted into the different fight types and enlarged for your convenience.
